...
#curl -H "Content-type: application/json" -X GET http://localhost:4000/api/menus/1/menu-items/
curl -d '{ "menuItem": { "name": "Dave Dish", "description": "ZZZ", "inventory": "2", "price": 200 }}' -H "Content-type: application/json" -X POST http://localhost:4000/api/menus/1/menu-items
